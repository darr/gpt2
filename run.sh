...
## Modified date : 2019-03-22 12:52
## Author : DARREN
## Describe : not set
...
#pip install /home/liuzy/data/NLP/spaCy/de_core_news_sm-2.0.0.tar.gz
#pip install /home/liuzy/data/NLP/spaCy/en_core_web_sm-2.0.0.tar.gz
#pip install pytorch-pretrained-bert
#pip install spacy ftfy
#python ./openai_gpt2/run_test.py
python main.py
#python unit_test.py
