...
# -*- coding: utf-8 -*-
#####################################
# File name : gpt2_double_heads_model.py
# Create date : 2019-03-05 23:09
# Modified date : 2019-03-23 16:02
# Author : DARREN
# Describe : not set
...
from .gpt2.base_gpt.model_multiple_choice_head import GPT2MultipleChoiceHead
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, mc_token_ids, lm_labels=None, mc_labels=None, token_type_ids=None, position_ids=None, past=None):
        ...
        #pylog.info("mc_logits.size:%s" % mc_logits.size().__str__())
